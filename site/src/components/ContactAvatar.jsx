...
// Copia de `src/components/ui/ContactAvatar.jsx`, igual que `Logo.jsx`: si
// cambia uno, cambian los dos. El marcador de un contacto sin foto en el mock
// de la bandeja (`landing/AppMock.jsx`) — doce fantasmas de la marca, uno de
// fondo de color y una cara distinta cada uno. Salen del pliego
