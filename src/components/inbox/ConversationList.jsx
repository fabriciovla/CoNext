...
const ORDENES = [
  { value: 'recientes', label: 'Abiertas, recientes' },
  { value: 'antiguas', label: 'Abiertas, antiguas' },
    ...
    <div className="flex h-full w-[336px] shrink-0 flex-col border-r border-tint/[0.07] bg-surface-card">
      <header className="shrink-0 px-3 pt-2.5">
        ...
        <div className="flex items-center justify-between gap-2 py-2">
          <Select
            variant="plain"
            ariaLabel="Ordenar conversaciones"
            value={orden}
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-0.5 flex items-center gap-1.5">
                      ...
                      {group.notas > 0 && (
                        <span title="Tiene notas internas" className="flex shrink-0 text-ink-faint">
                          <IconNote size={12} />
                        </span>
                      )}
                      {group.lastFromBot && (
                        <span title="La última respuesta la mandó un agente" className="flex shrink-0 text-ink-faint">
                          <IconBolt size={12} />
                        </span>
                      )}
                      {group.pendientes > 0 && (
                      ...
                      {group.assignee && (
                        <span title={`Responsable: ${group.assignee}`} className="flex shrink-0">
