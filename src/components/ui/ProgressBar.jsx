...
export default function ProgressBar({ value, delay = 0, className = 'bg-violet', trackClassName = '' }) {
  ...
  return (
    <div className={`h-1 w-full overflow-hidden rounded-full bg-tint/[0.08] ${trackClassName}`}>
      <div
